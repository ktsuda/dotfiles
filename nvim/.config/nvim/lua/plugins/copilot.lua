return {
  ...
  config = function()
    ...
    vim.keymap.set('i', '<C-n>', '<Plug>(copilot-next)', { desc = 'Copilot: Move to the next suggestion' })
    vim.keymap.set('i', '<C-p>', '<Plug>(copilot-previous)', { desc = 'Copilot: Move to the previous suggestion' })
